<?php
    ...
    if(isset($_POST["username"]) && isset($_POST["password"])) {
        ...
        if(($username == "student" && $password == "student")|| ($username == "bc-college" && $password == "bc-college") || ($username == "teacher" && $password == "teacher") || ($username == "react" && $password == "react"))
        {
            session_start(); 
            $_SESSION['username'] = $username;
            // Another way to acces the value of username
            //$username = $_POST["username"]; 
